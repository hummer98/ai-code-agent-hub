...
| ID | 要求 | 優先度 | ステータス | 受け入れ条件 | 対応設計書 |
|----|------|--------|-----------|------------|-----------|
| NFR-001 | Docker 隔離 | 高 | 未着手 | ホストマシンのプロセスに干渉しない (→ FR-010) | [infrastructure](../design/infrastructure.md) |
| NFR-002 | メモリ制限 | 中 | 未着手 | 3-5 リポジトリ同時稼働で 4GB 以内 | [infrastructure](../design/infrastructure.md) |
...
| NFR-005 | QNAP 互換 | 高 | 未着手 | QNAP Container Station (Docker Compose) で動作する (→ FR-010) | [infrastructure](../design/infrastructure.md) |
| NFR-006 | セッション永続化 | 中 | 未着手 | コンテナ再起動後もセッション履歴が保持される (Volume mount) | [infrastructure](../design/infrastructure.md) |
